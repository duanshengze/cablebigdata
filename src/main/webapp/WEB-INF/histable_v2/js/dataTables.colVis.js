...
ColVis.prototype = {
	...
	"_fnDomRestoreButton": function ()
	{
		...
		return $(
				'<li class="'+(dt.bJUI ? 'ui-button ui-state-default' : '')+'" style="color:#009ae7">'+
					this.s.restore+
				'</li>'
			)
			.click( function (e) {
	...
	"_fnCollectionShow": function ()
	{
		...
		var nOverflow = this.dom.collection;
		var iDivX = parseInt(oPos.left, 10);
		//var iDivX = parseInt(oPos.left - 246, 10);
		...
		document.body.appendChild( nOverflow );
