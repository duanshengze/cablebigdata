						...
						<div class="row" style="padding:0 10px 0 10px">
							...
							<div class="col-sm-12" style="border-bottom:1px dotted #e7e7e7;line-height:20px">
								...
								<div class="col-sm-1" style="width:10%;padding-right:0"><h5>时间：</h5></div>
									<div class="col-sm-3" style="width:6%"><!-- dateFmt:'yyyy/mm/dd',  -->
										<input id="paramDate" type="text" onClick="var start=$dp.$('paramDate');WdatePicker({skin:'whyGreen',onpicked:function(){dateValueChanged();},isShowOthers:false,maxDate:'%y'})" 
												...
												style="width:100px;margin:5px 0px;display:inline;font-size: 12px;height:25px;border-radius: 5px;border: 1px solid #c3c3c3;padding-left: 10px;background: url('<%=basePath %>HUMEPInsight/img/date.PNG') #fff no-repeat right;"/>
									</div>
									<label class="col-sm-3" style="font-weight:normal;display:inline;width:0px;margin:7px -1px;" title="到">到</label>
									<div class="col-sm-3" style="width:7%"><!-- dateFmt:'yyyy/mm/dd',  -->
										<input id="paramDateEnd" type="text" onClick="var start=$dp.$('paramDateEnd');WdatePicker({onpicked:function(){dateValueChanged();},isShowOthers:false, maxDate:'%y'})" 
												...
												style="width:100px;margin:5px -10px;display:inline;font-size: 12px;height:25px;border-radius: 5px;border: 1px solid #c3c3c3;padding-left: 10px;background: url('<%=basePath %>HUMEPInsight/img/date.PNG') #fff no-repeat right;"/>
									</div>
...
// 			 控制报表收起功能
			...
			$("#widget-foot").after("<iframe id='content_frame_old' name='tableiframe' src='"+basePath+"HUMEPInsight/CN/InsHisView/page/hiswarn_newtable.jsp' width='100%' height='400px' frameborder='0'/>");
